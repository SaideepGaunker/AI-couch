  ...
  function InterviewChatController(
    ...
    function initializeInterview() {
      ...
      if (!vm.questions || vm.questions.length === 0) {
        ...
        vm.error =
          "No questions available for this interview. Please try starting a new session.";
        return;
      }
      ...
      if (vm.questions.length > 0) {
        ...
        addChatMessage(
          "ai",
          "Welcome to your interview! I'll be asking you questions and you can respond using voice or text. Let's begin!"
        );
